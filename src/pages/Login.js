                ...
                <div className='max-w-[450px] h-[600px] mx-auto bg-black/70 text-white'>
                    <div className='max-w-[320px] mx-auto py-10'>
                        ...
                        <form className='w-full flex flex-col py-4 '>
                            ...
                            <button className='px-6 py-2 bg-red-600 hover:rounded-full ease-out duration-500 my-6 '>Log In</button>
                            ...
                            <div className='px-4'>
                            <p className='mt-12 text-sm text-gray-400'>Don't have an account? <span className='text-white'><Link to={'/signup'}> Sign Up</Link></span></p>
                            </div>
                        </form>
                    </div>
                </div>
